### P-Tuning
Промтинг(discrete promting) - написанные вручную шаблоны подсказок в качестве дополнительных входных данных для языковой модели. Он позволяет улучшить результаты предобученных языковых моделей.
...
<img src="images/PT_ineffective_promts.png" width="600" title="Таблица 1.">
                                                    
Было несколько работ, в которых были попытки найти способ подбора наиболее эффективного промта[[1](https://arxiv.org/abs/2103.10385), [2](https://arxiv.org/abs/2010.15980), [3](https://arxiv.org/abs/2012.15723)].
...
<img src="images/PT.png" width="600", title="Схема для P-Tuning">

Если раньше дописывали промт $P$ к нашему тексту $X$, пропускали $[P, X]$ через слой эмбеддингов, получая $[e(P), e(X)]$, то теперь мы сначала некторорым энкодером $H$ получаем эмбеддинги $h(P)$ для $P$ и затем конкатенируем с $e(X)$. 
...
<img src="images/ia3_metrics.png" width="600">
