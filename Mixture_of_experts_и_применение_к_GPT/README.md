...
Ансамблем называется алгоритм, который состоит из нескольких алгоритмов машинного обучения.
...
Mixture of Experts (MoE) - это метод машинного обучения, который объединяет прогнозы нескольких подмоделей, называемых экспертами, для принятия коллективного решения.
...
Впервые модель смеси экспертов была предложена в 1991 году и нашла свое применение в задачах регрессии, классификации с использованием классических алгоритмов машинного обучения.
...
Немногим позднее (в 1993 году) те же авторы представили обобщение описанной модели - иерархическая модель Mixture of Experts.
...
Основные проблемы представленный заключаются в их долгом и сложном обучении, для некоторого упрощения предполагают, что выход компоненты Gate представляет собой разреженный вектор, что подводит нас к модели: Sparsely-Gated Mixture-of-Experts.
...
2. https://www.cs.toronto.edu/~hinton/absps/hme.pdf
3. https://www.researchgate.net/publication/260707711_Twenty_Years_of_Mixture_of_Experts 
