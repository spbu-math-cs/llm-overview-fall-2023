...
1. Разделение текста: Исходный текст разделяется на самые маленькие единицы, такие как буквы или символы. Например, предложение "Hello world" может быть разбито на `['H', 'e', 'l', 'l', 'o', ' ', 'w', 'o', 'r', 'l', 'd']`.
...
4. Обновление текста: Весь текст обновляется путем замены самых частых пар субслов на соответствующие им новые. Например, пара ('l', 'l') может быть объединена в символ 'll', а предложение "Hello world" может стать "He(ll)o wor(ld)".
