...
Отдельно стоит упомянуть скорости, присущие самим вычислительным устройствам, а не системам с ними. Обычно подобные значения определяются опытным путем с помощью [микробенчмаркинга](https://arxiv.org/pdf/1804.06826.pdf):
